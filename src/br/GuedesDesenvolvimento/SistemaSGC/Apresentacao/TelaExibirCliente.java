...
public class TelaExibirCliente extends javax.swing.JFrame {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        try {
            if (linhaSelecionada < 0) {
                ...
                TelaEditarClientes telaEditarClientes = new TelaEditarClientes(clienteSelecionado);
                telaEditarClientes.setVisible(true);
            }
        } catch (Exception e) {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        String mensagem = "Deseja excluir? " + clienteSelecionado.getNome();
